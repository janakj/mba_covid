...
%   \hspace{0.2cm}
%   \subfloat[Average Hourly Uploaded MB per User before COVID-19 on Weekends\label{upload-b}]{%
%         \includegraphics[width=0.48\linewidth]{figs/wenjun/upload_wends_before.png}}
%     \\
%   \subfloat[Average Hourly Uploaded MB per User after COVID-19 on Weekdays\label{upload-c}]{%
...
%     \\
%   \subfloat[March to June: Average Hourly Uploaded MB per User on Weekdays\label{upload-e}]{%
...
%In order to figure out how the internet use behaviors may be changed because of COVID-19, we additionally analyze differences between downloaded and uploaded data based on both weekdays and weekends, before and after the COVID-19 pandemic.

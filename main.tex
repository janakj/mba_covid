...
Similarly to the average download speed, we also computed the ratio between the average upload speed experienced by users in January and March 2020. Define $S_{\text{upload}}$ as the upload speed, similar to the ratios for average download speed, the formula used can be represented as:
...
\begin{equation}
Data_{downloaded}\% = \frac{Data_{downloaded,\, March}}{Data_{downloaded,\, January}}
\end{equation}

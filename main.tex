...
% Comcast: https://corporate.comcast.com/covid-19/network/may-20-2020
% CTIA: https://www.ctia.org/covid-19
% Spectrum: https://www.spectrum.net/page/covid-19-update
% NCTA: https://www.ncta.com/COVIDdashboard
% Nokia: https://www.nokia.com/blog/redoing-the-math-the-impact-of-covid-19-on-broadband-networks/
% Sandvine: https://www.sandvine.com/covid-19-trends

% Google: https://blog.google/inside-google/infrastructure/keeping-our-network-infrastructure-strong-amid-covid-19/
% Akamai: https://blogs.akamai.com/sitr/2020/04/parts-of-a-whole-effect-of-covid-19-on-us-internet-traffic.html
% Facebook: https://about.fb.com/news/2020/03/keeping-our-apps-stable-during-covid-19/

% FCC Keep Americans Connected: https://www.fcc.gov/keep-americans-connected

% NANOG: https://storage.googleapis.com/site-media-prod/documents/20200601_Labovitz_Effects_Of_Covid-19_v1.pdf
...
\subfigure[Average Number of Download Data per User over Hour Before COVID-19 on Weekdays.]{

\begin{minipage}[t]{0.48\textwidth}
\centering\captionsetup{width=.8\linewidth}%
\includegraphics[width=1\textwidth]{figs/wenjun/download_wdays_before.png}
%\caption{fig1}
\end{minipage}%
}%
\subfigure[Average Number of Download Data per User over Hour Before COVID-19 on Weekends.]{
\begin{minipage}[t]{0.48\textwidth}
\includegraphics[width=1\textwidth]{figs/wenjun/download_wends_before.png}
%\caption{fig2}
\end{minipage}%
}%

\subfigure[Average Number of Download Data per User over Hour After COVID-19 on Weekdays.]{
\begin{minipage}[t]{0.5\linewidth}
\includegraphics[width=1\textwidth]{figs/wenjun/download_wdays_after.png}
%\caption{fig2}
\end{minipage}
}%
\subfigure[Average Number of Download Data per User over Hour After COVID-19 on Weekends.]{
\begin{minipage}[t]{0.5\linewidth}
\includegraphics[width=1\textwidth]{figs/wenjun/download_wends_after.png}
%\caption{fig2}
\end{minipage}
}%

\subfigure[Average Number of Download Data per User over Hour on Weekdays.]{
\begin{minipage}[t]{0.5\linewidth}
% \centering
\includegraphics[width=1\textwidth]{figs/wenjun/download_wdays_compare.png}
%\caption{fig1}
\end{minipage}%
% \label{fig:download-wdays-compare} 
}%
\subfigure[Average Number of Download Data per User over Hour on Weekends.]{
\begin{minipage}[t]{0.5\linewidth}
% \centering
\includegraphics[width=1\textwidth]{figs/wenjun/download_wends_compare.png}
%\caption{fig2}
\end{minipage}%
}%

\caption{Graphs related to Average Number of Download Data per Users over Hours on each Month. There is a peak between 18:00p.m. and 22:00p.m., which is the internet rush hour.}
\label{fig:download-data-per-user-hours-fig} 
\end{figure*}
